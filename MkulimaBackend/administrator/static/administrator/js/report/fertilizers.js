...
document.addEventListener("DOMContentLoaded", function loader(e) {
    if (loadCount < 1) {

        // handles logic of fertilizer names
        famountContainers = document.getElementsByClassName('fname')
        for (let container of famountContainers) {
            data = container.innerText
            datalist = data.split(', ')
            container.innerText = ""
        ...
        // handles logic of fertilizer amount...
        famountContainers = document.getElementsByClassName('famount')
        for (let container of famountContainers) {
            data = container.innerText
            datalist = data.split(', ')
